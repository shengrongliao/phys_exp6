...
start_idx1, end_idx1, start_idx2, end_idx2 = 450, 1000, 1250, 2200
x_fit = np.concatenate((x[start_idx1:end_idx1], x[start_idx2:end_idx2]))
y_fit = np.concatenate((y[start_idx1:end_idx1], y[start_idx2:end_idx2]))
...
plt.axvspan(x[start_idx1], x[end_idx1 - 1], color='gray', alpha=0.2)
plt.axvspan(x[start_idx2], x[end_idx2 - 1], color='gray', alpha=0.2)
